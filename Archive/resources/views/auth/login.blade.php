        ...
        <form action="{{ route('login.post') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2 text-white">
                ...
                <div class="relative group">
                    ...
                    <input type="email" name="email" value="{{ strtolower($role ?? '') }}@example.com" class="w-full pl-14 pr-6 py-5 input-glass rounded-2xl text-white placeholder-slate-600 outline-none" placeholder="Masukkan email anda" required>
                </div>
                @error('email')
            ...
            <div class="space-y-2 text-white">
                ...
                <div class="relative group">
                    ...
                    <input type="password" name="password" value="password" class="w-full pl-14 pr-6 py-5 input-glass rounded-2xl text-white placeholder-slate-600 outline-none" placeholder="••••••••" required>
                </div>
            </div>
